...
def main(page: ft.Page):
    ...
    # --- وظيفة تكبير الصور (المحدثة لتعمل مع القسم الجديد) ---
    ...
    # ---------------- NEW WORK ITEM COMPONENT (From tut.py) ----------------
    ...
    hero = ft.Container(
        ...
        content=ft.Column(
            ...
            controls=[
                ...
                ft.Text("نصنع هويتك الرقمية باحتراف", size=16, color="white70"),
                ft.Container(height=10),
                ft.ElevatedButton(
                    text="اطلب الآن",
                    bgcolor="white",
            ...
            ft.Container(
                ...
                content=ft.Column(
                    ...
                    controls=[
                        ...
                        service_card(ft.icons.PHONE_IPHONE, "تصميم تطبيقات", "واجهات عصرية وتجربة مستخدم"),
    ...
    works_page = ft.Container(
        ...
        content=ft.Column(
            ...
            controls=[
                ...
                work_item("هوية شركة تكنولوجيا", "تصميم شعارات", "https://images.unsplash.com/photo-1634942537034-2531766767d1?w=500"),
                work_item("تطبيق توصيل طعام", "واجهة مستخدم UI", "https://images.unsplash.com/photo-1551288049-bbbda5012375?w=500"),
                work_item("حملة رمضانية", "سوشيال ميديا", "https://images.unsplash.com/photo-1614850523296-d8c1af93d400?w=500"),
                work_item("غلاف مجلة فنية", "مطبوعات", "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=500"),
            ]
        )
    )
            ...
            controls=[
                ft.Column(
                    ...
                    controls=[
                        ...
                        ft.Text("ابدأ رحلتك الإبداعية معنا", size=22, weight="bold", color=DARK),
    ...
    about_page = ft.Container(
        ...
        content=ft.Column(
            scroll=ft.ScrollMode.AUTO,
            controls=[
                ft.Text("من نحن؟", size=24, weight="bold"),
                ft.Container(
                    bgcolor="white", border_radius=20, padding=20,
                    content=ft.Text(ABOUT_TEXT, size=14, text_align=ft.TextAlign.RIGHT)
                )
            ]
        )
    )
